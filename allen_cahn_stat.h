/**********************************************************************
 * $Id: allen_cahn_stat.h 1397 2014-02-02 22:42:29Z kanschat $
 *
...
template <int dim>
void AllenCahnPolynomialResidual<dim>::cell(
  DoFInfo<dim>& dinfo, 
  IntegrationInfo<dim>& info) const
{
...
template <int dim>
void AllenCahnPolynomialResidual<dim>::boundary(
  DoFInfo<dim>& dinfo, 
  IntegrationInfo<dim>& info) const
{
...
template <int dim>
void AllenCahnPolynomialResidual<dim>::face(
  DoFInfo<dim>& dinfo1, 
  DoFInfo<dim>& dinfo2,
  IntegrationInfo<dim>& info1, 
  IntegrationInfo<dim>& info2) const
...
template <int dim>
void AllenCahnPolynomialError<dim>::cell(
  DoFInfo<dim>& dinfo, 
  IntegrationInfo<dim>& info) const
{
...
template <int dim>
void AllenCahnPolynomialError<dim>::boundary(
  DoFInfo<dim>&, 
...
template <int dim>
void AllenCahnPolynomialError<dim>::face(
  DoFInfo<dim>&, 
  DoFInfo<dim>&, 
  IntegrationInfo<dim>&, 
  IntegrationInfo<dim>&) const
