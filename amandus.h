...
public:
  ...
  */
  AmandusApplicationSparse(dealii::Triangulation<dim>& triangulation,
                           const dealii::FiniteElement<dim>& fe, bool use_umfpack = false);
   ...
   * <code>out</code>.
   */
  void assemble_right_hand_side(dealii::AnyData& out, const dealii::AnyData& in,
   ...
   */
  void error(dealii::BlockVector<double>& out, const dealii::AnyData& in,
             const AmandusIntegrator<dim>& integrator);
   ...
   */
  void error(const dealii::AnyData& in, const AmandusIntegrator<dim>& integrator,
   ...
   */
  void verify_residual(dealii::AnyData& out, const dealii::AnyData& in,
                       const AmandusIntegrator<dim>& integrator) const;
 ...
 */
template <int dim>
class AmandusResidual : public dealii::Algorithms::OperatorBase
{
public:
  /**
 ...
 */
template <int dim>
class AmandusSolve : public dealii::Algorithms::OperatorBase
{
public:
  /**
...
inline void AmandusApplication<dim, RELAXATION>::set_advection_directions(
  std::vector<dealii::Tensor<1, dim>>& adv_dir)
{
